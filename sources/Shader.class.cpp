...
/*   Updated: 2018/03/24 20:46:10 by rmc-coma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Shader::Shader(const std::string sourcecode, const t_shader_type type) : _GL_ID(0),
																		 _Type(static_cast<GLenum>(type)),
																		 _Path(NULL),
																		 _Source(NULL)
{
...
void	Shader::compile(void)
{
	...
	if (!this->_Source)
		throw (std::runtime_error("Shader compilation needed but shader has no source"));
